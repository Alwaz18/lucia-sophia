...
import CfTwo from './CfTwo'

function Footer() {
    return (
        <footer className='min-h-screen mainbg mt-64 center flex-wrap h-full w-full' id="footer">

            <section className="center h-full w-full my-20">
            <div>
            ...
            <div className="flex md:justify-between justify-center flex-wrap items-start  h-full w-5/6">
                ...
                <div className=" flex flex-col items-center justify-start h-full  md:w-1/3 w-3/4 my-4">
                    <div className="center flex-col">
                     ...
                     text-gray-400 hover:text-yellow-400  text-sm px-8 py-4 rounded-2xl border border-yellow-600">
                ...
                <div className="flex flex-col items-center justify-start h-full md:w-1/3 w-1/2 px-4 py-6">
                    ...
                    <div className="container flex justify-around items-center">
                        <ul className="px-6 center">
                            ...
                            <li className="px-4 py-6 rounded-full
             ">
             ...
             ">
                ...
                <div className="flex-col center h-full md:w-1/3 w-1/2 px-4 py-6">
                    ...
                    <ul>
                        <li><Link href="/products/#category"><a className="text-sm custom-roboto text-gray-400 hover:text-gray-600">Categories</a></Link></li>
                        <li><Link href="/#hot"><a className="text-sm custom-roboto text-gray-400 hover:text-gray-600">Top products</a></Link></li>
                        <li><Link href="/testimonials"><a className="text-sm custom-roboto text-gray-400 hover:text-gray-600">Testimonials</a></Link></li>
                    </ul>
                </div>
            </div>
            <p className="custom-montserrat p-2 md:text-sm text-xs self-end justify-start min-w-full text-gray-500">© 2021 Lucia Sophia. All Rights Reserved.</p>
